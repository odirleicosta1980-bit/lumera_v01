...
import { CreateEmpenhoForm } from './create-empenho-form';
export function CreateEmpenhoModal({ licitacaoId }: { licitacaoId: string }) {
    ...
    <>
      ...
      {isOpen ? (
        ...
        >
          <button
            type='button'
            aria-label='Fechar modal de novo empenho'
          ...
          >
            ...
            <CreateEmpenhoForm licitacaoId={licitacaoId} onSuccess={() => setIsOpen(false)} onCancel={() => setIsOpen(false)} />
          </div>
        </div>
      ) : null}
    </>
